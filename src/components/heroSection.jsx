...
function HeroSection() {
    ...
    useEffect(() => {
      ...
      const timeout = setTimeout(updateProfile, 500);
  ...
  return (
    <div>
    <div class="bg-white mb-5 relative flex justify-center items-center   lg:pt-25 dark:bg-gray-900">
        <div class="relative xl:container md:px-12 ">
            <div class="lg:flex items-center justify-around sm:grid sm:grid-rows-3 ">
               <div className='sm:relative'>
                
               <h1 class="duration-500 sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl dark:text-white">Hi, I'm Mouhamed NDIAYE, <br class="lg:block hidden"/> <span class="relative text-transparent bg-clip-text bg-gradient-to-r  from-blue-600 to-cyan-500 dark:from-blue-400 dark:to-cyan-300">{currentProfile}|</span>.</h1>
               <div class="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
                    ...
                    Welcome to my portfolio! I'm passionate about mobile web development, with diverse expertise ranging from personal apps to enterprise solutions. My goal is to deliver seamless and responsive experiences across various platforms. Explore my achievements and reach out to discuss your mobile web projects.                    </p>
