...
function Projects() {
    ...
    return (
        <div>
            <h1 class="duration-500 m-10 sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-blue-900 text-xl text-center sm:text-5xl md:text-6xl lg:w-auto ">My Project </h1>
                    ...
                    Project.map(project => (
                        <div class=" project bg-white sm:w-[200px] shadow-md border lg:w-[400px] border-gray-200 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700 m-3">
                            ...
                            <div class="p-5">
                                ...
                                <a href={project.site} class="text-white  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                ...
                                <a href="#" class="text-white  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
